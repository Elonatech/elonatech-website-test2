...
// ===============================
  const [navItems, setNavItem] = useState(false);
  ...
  const NavbarItems = () => {
      ...
      // if (window.scrollY > 125 && window.scrollY  < 350){
      //  setNavItem(true);
      // } else {
      //   setNavItem(false);
      // }
  };
  window.addEventListener("scroll", NavbarItems);
...
return (
<>
  <nav id="navbarShow" className={scroll  ? "navbar navbar-expand-lg navbar-dark  fixed-top NAVbar" : ' navbar navbar-expand-lg navbar-dark fixed-top NAVba'} class={  navItems ? "NabarItemDisplayNone"  : "navbar navbar-expand-lg navbar-dark fixed-top NAVba" }   >
    <div class="container-fluid" >
      <Link  to={'/'}   className='navbar-brand border-0' ><img  src={logo} id='elonatech-logo-home' class="lazyload border-0"/></Link>
      <button class="navbar-toggler custom-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar2" aria-controls="offcanvasNavbar2" aria-label="Toggle navigation">
       ...
       <div class="offcanvas offcanvas-end navbar-bg-change" style={{width:"350px", height:"608px"}}  tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title text-dark"  id="offcanvasNavbar2Label"></h5>
          <div class="btn-close btn-close-white active  dismiss-nav-man" data-bs-dismiss="offcanvas" aria-label="Close"></div>
        </div>
        <div class="offcanvas-body"  >
           <ul class="navbar-nav mx-auto"   >
    {/*============================================  first drop down ===============================================*/}
            <li class="nav-item pe-4">
              <Link to={'/'} class="nav-link fw-bold active dismiss-nav-man" data-bs-dismiss="offcanvas"><i class="bi bi-house-fill"></i></Link>
            </li>
            <li class="nav-item mx-0   pe-2 my-md-0 active elonatechlistItem" onMouseEnter={handleProductHover}><a onClick={handleProductClick } style={{fontWeight:"bold"}} class="nav-link e-fonte text-white dropdown-toggle">Solutions</a>
            <ul id="myDIV" className= {productHover  ? 'elonatechinnerListContainer ' : 'elonatechmainDropdownDone'}>
            <li className='elonatechinnerListItemLeft'>
            <ul className='elonatechinnerListContentLeft'>
            <li className={techMouseEnter ? 'elonatechinnerListItemContentLeftActive' : 'elonatechinnerListItemContentLeft'} onMouseEnter={handleTechMouseEnter}> <h6 className='techCenter'>Tech Solution</h6></li>
            <li className={digitalMouseEnter ? 'elonatechinnerListItemContentLeftActive' : 'elonatechinnerListItemContentLeft'} onMouseEnter={handleDigitalMouseEnter}><h6 className='techCenter'>Digital Solution</h6></li>
            <li className={salesMouseEnter ? 'elonatechinnerListItemContentLeftActive' : 'elonatechinnerListItemContentLeft'} onMouseEnter={handleSalesMouseEnter}><h6 className='techCenter'><span className='salesSupply'>Sales /</span> <span className='saleSupplyAnd'>Sales and</span> Supply</h6></li>
            </ul>
            </li>
            ...
            {/*===================================== hardware solution =============================================================*/}
            <li className={'elonatechinnerListItemContentRightTechListItem'} onMouseEnter={handleHardwareMouseOver} > <div className="elonatechtest"><h6 onClick={handleHardwareMouseClick}   className={hardwareMouseOver ||   hardwareMouseClick ? 'elonatechinnerListItemContentRightTechListTitleActive elonatechSolutionsTitle' : 'elonatechinnerListItemContentRightTechListTitle  elonatechSolutionsTitle'}>Hardware Solutions </h6> { hardwareMouseClick? <HiOutlineXMark style={{color:'red'}}/> : <><i class="bi bi-plus text-dark fs-3"></i></>  } </div>
            <ul className={ hardwareMouseOver ||   hardwareMouseClick ? 'elonatechhardwareSolutionsListActive' : 'elonatechhardwareSolutionsList'}>

            <Link to={'/hardware-engineering'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"> <li className={'elonatechhardwareSolutionsListItem'}> <img data-src={hardwareComputer} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>Computer Engineering</li></Link>

            <Link to={'/printer-repair'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechhardwareSolutionsListItem'}> <img data-src={hardwareOffice} className='lazyload'  style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>Printers </li></Link>

            <Link to={'/mobile-repair'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechhardwareSolutionsListItem'}> <img data-src={hardwarePhone} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>Mobile Devices</li></Link>

            <Link to={'/network'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechhardwareSolutionsListItem'}><img src={hardwareMaintenance} className='lazyload'  style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/> Networking Equipments</li></Link>

            </ul>
            </li>
              {/*=============================================== network solution ====================================================*/}
              <li className={'elonatechinnerListItemContentRightTechListItem'} onMouseEnter={handleNetworkMouseOver} > <div className="elonatechtest"><h6 onClick={handleNetworkMouseClick} className={networkMouseOver || networkMouseClick ? 'elonatechinnerListItemContentRightTechListTitleActive  elonatechSolutionsTitle' : 'elonatechinnerListItemContentRightTechListTitle elonatechSolutionsTitle'} >Network Solutions</h6> { networkMouseClick? <HiOutlineXMark style={{color:'red'}} /> :<><i class="bi bi-plus text-dark fs-3"></i></> } </div>
              <ul className={ networkMouseOver ||   networkMouseClick ? 'elonatechnetworkAdministrationListActive' : 'elonatechnetworkAdministrationList'}>
              <Link to={'/network-administration-implementation'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"> <li className={'elonatechnetworkAdministrationListItem'}> <img data-src={networkAdmin} className='lazyload' style={{alignSelf: "center", width: "50px", height: "50px", objectFit: "contain"}}/>Network Admin/Implementation </li></Link>

              <Link to={'/network-security'} class="text-decoration-none text-dark pe-2 dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechnetworkAdministrationListItem'}> <img data-src={networkSecurity} className='lazyload' style={{alignSelf: "center", width: "50px", height: "50px", objectFit: "contain"}}/>Network Security</li></Link>

              <Link to={'/server-administration'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechnetworkAdministrationListItem'}> <img data-src={networkServer} className='lazyload' alt="" style={{alignSelf: "center", width: "50px", height: "50px", objectFit: "contain"}}/>Server Administration</li></Link>

              <Link to={'/system-integration'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechnetworkAdministrationListItem'}> <img data-src={networkInfastructure} className='lazyload' alt="" style={{alignSelf: "center", width: "50px", height: "50px", objectFit: "contain"}}/>Infrastructure / System Integration </li></Link>

              <Link to={'/structure-cabling'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechnetworkAdministrationListItem'}> <img data-src={networkCabling} className='lazyload' style={{alignSelf: "center", width: "50px", height: "50px", objectFit: "contain"}}/>Structured cabling</li></Link>

              <Link to={'/cctv'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechnetworkAdministrationListItem'}> <img data-src={networkCctv} className='lazyload'  style={{alignSelf: "center", width: "50px", height: "50px", objectFit: "contain"}}/>CCTV Installation</li></Link>

              <Link to={'/internet'} class="text-decoration-none text-dark pe-2 dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechnetworkAdministrationListItem'}> <img data-src={networkInternet} className='lazyload' alt="" style={{alignSelf: "center", width: "50px", height: "50px", objectFit: "contain"}}/>Internet Solutions</li></Link>
               </ul>
              </li>
              {/*================================================ software solution =================================================*/}
              <li className={'elonatechinnerListItemContentRightTechListItem'} onMouseEnter={handleSoftwareMouseOver}> <div className="elonatechtest"><h6 onClick={handleSoftwareMouseClick}  className={softwareMouseOver || softwareMouseClick? 'elonatechinnerListItemContentRightTechListTitleActive elonatechSolutionsTitle' : 'elonatechinnerListItemContentRightTechListTitle elonatechSolutionsTitle'}>Software Solutions</h6>  { softwareMouseClick ? <HiOutlineXMark style={{color:'red'}}/> :<><i class="bi bi-plus text-dark fs-3"></i></>} </div>
              <ul className={softwareMouseOver || softwareMouseClick  ? 'elonatechsoftwareSolutionsListActive' : 'elonatechsoftwareSolutionsList'}>
              <Link to={'/system-software'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechsoftwareSolutionsListListItem'}> <img data-src={softwareSystem} className='lazyload' style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>System Software</li></Link>
              <Link to={'/application-software'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={"elonatechsoftwareSolutionsListListItem"}> <img data-src={softwareApplication} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>Application Software</li></Link>
              <Link to={'/business-software'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={"elonatechsoftwareSolutionsListListItem"}> <img data-src={softwareBusiness} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>Business Application Software</li></Link>
              </ul>
              </li>
                {/*=================================================== Communication ================================================*/}
                <li className={'elonatechinnerListItemContentRightTechListItem'} onMouseEnter={handleTelecomMouseOver}> <div className="elonatechtest"><h6  onClick={handleTelecomMouseClick} className={telecomMouseOver || telecomMouseClick ? 'elonatechinnerListItemContentRightTechListTitleActive elonatechSolutionsTitle' : 'elonatechinnerListItemContentRightTechListTitle elonatechSolutionsTitle'}>Communication</h6>  { telecomMouseClick ? <HiOutlineXMark style={{color:'red'}}/> : <><i class="bi bi-plus text-dark fs-3"></i></>}</div>
                <ul className={telecomMouseOver || telecomMouseClick ? 'elonatechtelecomsListActive' : 'elonatechtelecomsList'}>
                <Link to={'/ip-telephony'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechtelecomsListListItem'}> <img data-src={telecomsIp} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>IP Telephony & PBX Systems</li></Link>
                <Link to={'/voip'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechtelecomsListListItem'}> <img data-src={telecomsVoip} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>VoIP</li></Link>
                </ul>
                </li>
               {/*======================================================== access security ==========================================*/}
                <li className={'elonatechinnerListItemContentRightTechListItem'} onMouseEnter={handleSystemMouseOver} > <div className="elonatechtest"><h6  onClick={handleSystemMouseClick} className={systemMouseOver || systemMouseClick ? 'elonatechinnerListItemContentRightTechListTitleActive elonatechSolutionsTitle' : 'elonatechinnerListItemContentRightTechListTitle elonatechSolutionsTitle'}>Access & Security</h6>  { systemMouseClick ? <HiOutlineXMark style={{color:'red'}} /> :<><i class="bi bi-plus text-dark fs-3"></i></>} </div>
                <ul className={systemMouseOver || systemMouseClick ? 'elonatechsystemSecurityListActive' : 'elonatechsystemSecurityList'}>
                <Link to={'/access-control'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechsystemSecurityListListItem'}> <img data-src={systemAccess} className='lazyload'  alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/> Access Control</li></Link>
                <Link to={'/time-management'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechsystemSecurityListListItem'}> <img data-src={systemTime} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/> Time Management Solutions</li></Link>
                <Link to={'/surveillance'} class="text-decoration-none text-dark dismiss-nav-man" data-bs-dismiss="offcanvas"><li className={'elonatechsystemSecurityListListItem'}> <img data-src={systemSurveillnance} className='lazyload' alt="" style={{width: "50px", height: "50px", objectFit: "contain", alignSelf: "center"}}/>Surveillance</li></Link>
                </ul>
                </li>
                </ul>
                </li>
