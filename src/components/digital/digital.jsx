...
{/*================================================================ header ========================================================*/}
<div class="container-fluid bg-secondary py-5 " style={{height:"500px" , marginBottom:"10px" , backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://res.cloudinary.com/elonatech/image/upload/v1709802797/digitalPage/digital_marketing_palah3.jpg)`, backgroundRepeat:"no-repeat" , backgroundPosition:"center", backgroundSize:"cover"}}>
 <div class="py-5 mt-5 ">
   <h2 class=" mt-5 text-white text-center">Digital Marketing</h2>
   <h5 class=" mt-4 text-white text-center">Our mission is clear: Help you outsell, outperform and outlast your competitors.</h5>
   <p class="lead text-white text-center">Developing effective digital marketing in any market is tough, demanding, and technical. Hence the need to work with an agency with the experience, network, tools and know-how</p>
 </div>
 </div>
...
<ul className='d-flex row pt-5 g-3 justify-content-between list-unstyled'>
  ...
  <Link to={'/social-media-marketing'} className='text-decoration-none text-dark'>
  <div className="">
  <div className="text-center">
  ...
  <Link to={'/content-marketing'} className='text-decoration-none text-dark'>
  <div className="">
  <div className="text-center">
  ...
  <li className='col-6 col-md-4 col-lg-2 pt-5'>
  <Link to={'/email-marketing'} className='text-decoration-none text-dark'>
  <div className="">
  <div className="text-center">
